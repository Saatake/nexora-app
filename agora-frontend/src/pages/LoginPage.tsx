        ...
        <form onSubmit={handleLogin} className="space-y-5">
          ...
          <div className="space-y-1">
            ...
            <div className="relative">
              ...
              <input
                type="email"
                placeholder={roleTab === 'Aluno' ? "seu.email@universidade.edu.br" : "professor@universidade.edu.br"}
                value={email}
          ...
          <button
            type="submit"
            className="w-full py-3.5 bg-indigo-600 hover:bg-indigo-700 text-white text-sm font-bold rounded-xl shadow-lg transition-colors mt-6"
          >
            Entrar
          </button>
