...
namespace backend.Migrations
{
    ...
    [Migration("20260911162726_AddMentorshipTasks")]
    partial class AddMentorshipTasks
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Nexora.Api.Models.MentorshipTask", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("MentorshipGoalId")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("MentorshipGoalId");

                    b.ToTable("MentorshipTasks");
                });
            ...
            modelBuilder.Entity("Nexora.Api.Models.MentorshipTask", b =>
                {
                    b.HasOne("Nexora.Api.Models.MentorshipGoal", "MentorshipGoal")
                        .WithMany("Tasks")
                        .HasForeignKey("MentorshipGoalId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("MentorshipGoal");
                });
